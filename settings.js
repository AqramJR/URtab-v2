...
const PRESET_GRADIENTS = [
  ...
  { bg:'linear-gradient(135deg,#080812,#131326,#0c1420,#060610,#12122a)',           name:'Midnight ✦', anim:'anim-midnight' },
  { bg:'linear-gradient(135deg,#0f0c29,#302b63,#24243e,#1a1040,#4a3b8a)',          name:'Nebula ✦',   anim:'anim-nebula'   },
  { bg:'linear-gradient(135deg,#1a0533,#2d1b69,#11998e,#0a1a2e,#1a8060)',          name:'Aurora ✦',   anim:'anim-aurora'   },
  { bg:'linear-gradient(135deg,#0f2027,#203a43,#2c5364,#0a1520,#183848)',          name:'Ocean ✦',    anim:'anim-ocean'    },
];
